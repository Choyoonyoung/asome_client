    ...
    return (
      <styled.Container>
        <styled.FormBox>
          <h2>회의록 작성 일지</h2>
          <styled.Badge>
            <styled.BadgeText>New</styled.BadgeText>
          </styled.Badge>
        </styled.FormBox>
        ...
        {this.state.form.map((form, idx) => (
          <div className="form">
            ...
            <styled.PlusForm type="textarea" />
            <styled.Button
              type="button"
              onClick={this.handleRemoveForm(idx)}
              className="small">
              -
            </styled.Button>
          </div>
        ...
        <div>
          ...
          <input value={this.state.keyform} onChange={this.handleChange} />
        </div>
      </styled.Container>
    );
  }
